        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form action="Ecriture-Tableau.php" method="POST">
                    ...
                    <br>
                    <input id="nomPersonne" type="text" class="form-control" name="nom" placeholder="Entrez votre nom" value="<?php echo $preselection[1] ?>" disabled>
                    <label for="prenomPersonne">Prénom:</label>
                    <br>
                    <input id="prenomPersonne" type="text" class="form-control" name="prenom" placeholder="Entrez votre prénom" value="<?php echo $preselection[2] ?>" disabled>
                    <label for="mailPersonne">E-Mail:</label>
                    <br>
                    <input id="mailPersonne" type="email" class="form-control" name="email" placeholder="Entrez votre E-Mail" value="<?php echo $preselection[3] ?>" disabled>
                    <label for="phonePersonne">Téléphone:</label>
                    <br>
                    <input id="phonePersonne" type="tel" class="form-control" name="telephone" placeholder="Entrez votre téléphone" value="<?php echo $preselection[4] ?>" disabled>
